...
if (isset($_POST['btn_login'])) {
  ...
  $select = $pdo->prepare("SELECT * FROM blos_user WHERE useremail='$useremail'");

  $select->execute();

  $row = $select->fetch(PDO::FETCH_ASSOC);

  if ($row['useremail'] == $useremail and ($row['password']) and $row['role'] == "Admin") {
  ...
  } else if ($row['useremail'] == $useremail and ($row['password']) and $row['role'] == "User") {
  ...
  } else if ($row['useremail'] == $useremail and ($row['password']) and $row['role'] == "Sale") {
